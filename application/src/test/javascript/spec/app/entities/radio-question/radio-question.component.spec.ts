...
import { RadioQuestionComponent } from 'app/entities/radio-question/radio-question.component';
...
describe('Component Tests', () => {
  describe('RadioQuestion Management Component', () => {
    let comp: RadioQuestionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RadioQuestionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.radioQuestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
