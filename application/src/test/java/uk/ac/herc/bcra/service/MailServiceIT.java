...
public class MailServiceIT {
    ...
    public void testSendEmail() throws Exception {
        ...
        assertThat(message.getFrom()[0].toString()).isEqualTo(applicationProperties.getEmail().getFrom());
    ...
    public void testSendPasswordResetMail() throws Exception {
        ...
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailService.sendPasswordResetMail(user, RequestSource.ADMIN);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(applicationProperties.getEmail().getFrom());
    ...
    @Test
    public void testSendPasswordResetMailForParticipant() throws Exception {
        User user = new User();
        user.setLangKey(Constants.DEFAULT_LANGUAGE);
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailService.sendPasswordResetMail(user, RequestSource.QUESTIONNAIRE);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(applicationProperties.getEmail().getFrom());
