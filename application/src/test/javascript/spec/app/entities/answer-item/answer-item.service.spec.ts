...
describe('Service Tests', () => {
  describe('AnswerItem Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new AnswerItem(0, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a AnswerItem', async () => {
      ...
      it('should update a AnswerItem', async () => {
        const returnedFromService = Object.assign(
          {
            selected: true
          },
      ...
      it('should return a list of AnswerItem', async () => {
        const returnedFromService = Object.assign(
          {
            selected: true
          },
      ...
      it('should delete a AnswerItem', async () => {
