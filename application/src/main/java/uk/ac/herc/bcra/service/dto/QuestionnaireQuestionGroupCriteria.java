...
public class QuestionnaireQuestionGroupCriteria implements Serializable, Criteria {
    ...
    private StringFilter questionnaireUuid;
    ...
    public QuestionnaireQuestionGroupCriteria(QuestionnaireQuestionGroupCriteria other){
        ...
        this.questionnaireUuid = other.questionnaireUuid == null ? null : other.questionnaireUuid.copy();
    ...
    public StringFilter getQuestionnaireUuid() {
        return questionnaireUuid;
    }

    public void setQuestionnaireUuid(StringFilter questionnaireUuid) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(questionnaireUuid, that.questionnaireUuid) &&
    ...
    public String toString() {
        return "QuestionnaireQuestionGroupCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (uuid != null ? "uuid=" + uuid + ", " : "") +
                (questionnaireUuid != null ? "questionnaireUuid=" + questionnaireUuid + ", " : "") +
