...
import { CheckboxQuestionComponent } from 'app/entities/checkbox-question/checkbox-question.component';
...
describe('Component Tests', () => {
  describe('CheckboxQuestion Management Component', () => {
    let comp: CheckboxQuestionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CheckboxQuestionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.checkboxQuestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
