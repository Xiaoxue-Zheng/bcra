...
describe('QuestionGroupQuestion e2e test', () => {
  ...
  it('should create and save QuestionGroupQuestions', async () => {
    ...
    await promise.all([
      ...
      questionGroupQuestionUpdatePage.setQuestionGroupUuidInput('questionGroupUuid'),
      questionGroupQuestionUpdatePage.setQuestionUuidInput('questionUuid'),
    ...
    expect(await questionGroupQuestionUpdatePage.getQuestionGroupUuidInput()).to.eq(
      'questionGroupUuid',
      'Expected QuestionGroupUuid value to be equals to questionGroupUuid'
    );
    expect(await questionGroupQuestionUpdatePage.getQuestionUuidInput()).to.eq(
      'questionUuid',
      'Expected QuestionUuid value to be equals to questionUuid'
    );
