export const enum ReferralConditionType {
  ITEMS_AT_LEAST = 'ITEMS_AT_LEAST',
...
export const enum QuestionItemIdentifier {
  CONSENT_INFO_SHEET_2_YES = 'CONSENT_INFO_SHEET_2_YES',
  CONSENT_INFO_SHEET_2_NO = 'CONSENT_INFO_SHEET_2_NO',
