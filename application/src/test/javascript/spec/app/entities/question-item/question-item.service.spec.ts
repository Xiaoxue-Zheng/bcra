...
import { IQuestionItem, QuestionItem, QuestionItemIdentifier } from 'app/shared/model/question-item.model';
...
describe('Service Tests', () => {
  describe('QuestionItem Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a QuestionItem', async () => {
      ...
      it('should update a QuestionItem', async () => {
        const returnedFromService = Object.assign(
          {
            identifier: 'BBBBBB',
            order: 1,
      ...
      it('should return a list of QuestionItem', async () => {
        const returnedFromService = Object.assign(
          {
            identifier: 'BBBBBB',
            order: 1,
      ...
      it('should delete a QuestionItem', async () => {
