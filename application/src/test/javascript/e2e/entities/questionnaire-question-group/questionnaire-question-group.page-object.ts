...
export class QuestionnaireQuestionGroupUpdatePage {
  ...
  questionnaireUuidInput = element(by.id('field_questionnaireUuid'));
  ...
  async setQuestionnaireUuidInput(questionnaireUuid) {
    await this.questionnaireUuidInput.sendKeys(questionnaireUuid);
  }

  async getQuestionnaireUuidInput() {
    return await this.questionnaireUuidInput.getAttribute('value');
  }
