...
describe('Service Tests', () => {
  describe('AnswerGroup Service', () => {
    let injector: TestBed;
    let service: AnswerGroupService;
    let httpMock: HttpTestingController;
    let elemDefault: IAnswerGroup;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a AnswerGroup', async () => {
      ...
      it('should delete a AnswerGroup', async () => {
