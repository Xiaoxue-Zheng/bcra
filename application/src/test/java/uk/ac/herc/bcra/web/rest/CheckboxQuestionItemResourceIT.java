...
public class CheckboxQuestionItemResourceIT {
    ...
    public void createCheckboxQuestionItem() throws Exception {
        ...
        assertThat(testCheckboxQuestionItem.getQuestionUuid()).isEqualTo(DEFAULT_QUESTION_UUID);
    ...
    public void checkQuestionUuidIsRequired() throws Exception {
        int databaseSizeBeforeTest = checkboxQuestionItemRepository.findAll().size();
        // set the field null
        checkboxQuestionItem.setQuestionUuid(null);
    ...
    @Test
    @Transactional
    public void getAllCheckboxQuestionItemsByQuestionUuidIsEqualToSomething() throws Exception {
        // Initialize the database
        checkboxQuestionItemRepository.saveAndFlush(checkboxQuestionItem);

        // Get all the checkboxQuestionItemList where questionUuid equals to DEFAULT_QUESTION_UUID
        defaultCheckboxQuestionItemShouldBeFound("questionUuid.equals=" + DEFAULT_QUESTION_UUID);

        // Get all the checkboxQuestionItemList where questionUuid equals to UPDATED_QUESTION_UUID
        defaultCheckboxQuestionItemShouldNotBeFound("questionUuid.equals=" + UPDATED_QUESTION_UUID);
    }

    @Test
    @Transactional
    public void getAllCheckboxQuestionItemsByQuestionUuidIsInShouldWork() throws Exception {
        // Initialize the database
        checkboxQuestionItemRepository.saveAndFlush(checkboxQuestionItem);

        // Get all the checkboxQuestionItemList where questionUuid in DEFAULT_QUESTION_UUID or UPDATED_QUESTION_UUID
        defaultCheckboxQuestionItemShouldBeFound("questionUuid.in=" + DEFAULT_QUESTION_UUID + "," + UPDATED_QUESTION_UUID);

        // Get all the checkboxQuestionItemList where questionUuid equals to UPDATED_QUESTION_UUID
        defaultCheckboxQuestionItemShouldNotBeFound("questionUuid.in=" + UPDATED_QUESTION_UUID);
    }

    @Test
    @Transactional
    public void getAllCheckboxQuestionItemsByQuestionUuidIsNullOrNotNull() throws Exception {
        // Initialize the database
        checkboxQuestionItemRepository.saveAndFlush(checkboxQuestionItem);

        // Get all the checkboxQuestionItemList where questionUuid is not null
        defaultCheckboxQuestionItemShouldBeFound("questionUuid.specified=true");

        // Get all the checkboxQuestionItemList where questionUuid is null
        defaultCheckboxQuestionItemShouldNotBeFound("questionUuid.specified=false");
    }
    ...
    public void updateCheckboxQuestionItem() throws Exception {
        ...
        assertThat(testCheckboxQuestionItem.getQuestionUuid()).isEqualTo(UPDATED_QUESTION_UUID);
