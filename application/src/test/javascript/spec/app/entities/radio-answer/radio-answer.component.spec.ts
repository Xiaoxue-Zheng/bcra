...
import { RadioAnswerComponent } from 'app/entities/radio-answer/radio-answer.component';
...
describe('Component Tests', () => {
  describe('RadioAnswer Management Component', () => {
    let comp: RadioAnswerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RadioAnswerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.radioAnswers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
