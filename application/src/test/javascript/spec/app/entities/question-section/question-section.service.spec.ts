...
import { IQuestionSection, QuestionSection, QuestionSectionIdentifier } from 'app/shared/model/question-section.model';
...
describe('Service Tests', () => {
  describe('QuestionSection Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a QuestionSection', async () => {
        ...
        service
          .create(new QuestionSection(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a QuestionSection', async () => {
        const returnedFromService = Object.assign(
          {
            identifier: 'BBBBBB',
            order: 1,
      ...
      it('should return a list of QuestionSection', async () => {
        const returnedFromService = Object.assign(
          {
            identifier: 'BBBBBB',
            order: 1,
      ...
      it('should delete a QuestionSection', async () => {
