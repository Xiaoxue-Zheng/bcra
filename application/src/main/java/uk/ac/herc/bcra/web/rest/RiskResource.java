...
/**
 * REST controller for managing {@link uk.ac.herc.bcra.domain.Risk}.
 */
@RestController
@RequestMapping("/api")
public class RiskResource {
    ...
    public ResponseEntity<Risk> updateRisk(@Valid @RequestBody Risk risk) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, risk.getId().toString()))
            .body(result);
    }
