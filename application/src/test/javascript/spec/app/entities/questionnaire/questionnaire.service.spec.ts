...
import { IQuestionnaire, Questionnaire, QuestionnaireType } from 'app/shared/model/questionnaire.model';
...
describe('Service Tests', () => {
  describe('Questionnaire Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Questionnaire(0, QuestionnaireType.CONSENT_FORM, 0);
    });
