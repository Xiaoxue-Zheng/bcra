...
import uk.ac.herc.bcra.config.audit.AuditEventConverter;
import uk.ac.herc.bcra.domain.PersistentAuditEvent;
...
import static uk.ac.herc.bcra.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
