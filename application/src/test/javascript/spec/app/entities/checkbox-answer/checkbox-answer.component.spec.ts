...
import { CheckboxAnswerComponent } from 'app/entities/checkbox-answer/checkbox-answer.component';
...
describe('Component Tests', () => {
  describe('CheckboxAnswer Management Component', () => {
    let comp: CheckboxAnswerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CheckboxAnswerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.checkboxAnswers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
