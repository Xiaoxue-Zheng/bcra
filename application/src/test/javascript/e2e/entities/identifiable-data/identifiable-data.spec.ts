...
describe('IdentifiableData e2e test', () => {
  ...
  /* it('should create and save IdentifiableData', async () => {
        ...
        await promise.all([
            ...
            identifiableDataUpdatePage.participantSelectLastOption(),
            identifiableDataUpdatePage.csvFileSelectLastOption(),
        ]);
        ...
        expect(await identifiableDataUpdatePage.getPracticeNameInput()).to.eq('practiceName', 'Expected PracticeName value to be equals to practiceName');
        ...
        expect(await identifiableDataComponentsPage.countDeleteButtons()).to.eq(nbButtonsBeforeCreate + 1, 'Expected one more entry in the table');
    });*/
  ...
  /* it('should delete last IdentifiableData', async () => {
        ...
        expect(await identifiableDataDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Identifiable Data?');
